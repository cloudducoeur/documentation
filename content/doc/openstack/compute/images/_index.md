...
{{% callout type="info" %}}
Les images publiques sont mises à jour régulièrement par l'équipe d'exploitation. Elles incluent le package `cloud-init` nécessaire à l'injection de vos clés SSH et à la configuration réseau automatique.
{{% /callout %}}
